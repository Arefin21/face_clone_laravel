            ...
            <div class="row" style="padding: 10px;">
                <form action="{{route('posts.store')}}" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        <textarea placeholder="Whats up?" name="status" maxlength="250"></textarea>
    ...
    @foreach ($posts as $post)
        ...
        <div class="post col-sm-12" id="post_1">
            <div class="row post-heading">
                <div class="col-sm-12">
                    <a href="{{route('profile.index')}}">
                        <img src="{{asset(auth()->user()->image)??'/image/no_user.png'}}" class="profile-picture pull-left"/>
                        &nbsp;
            ...
            <div class="row post-body">
                ...
                <div class="col-sm-12">
<img src="{{$post['photo']}}" alt="" height="200" width="300">
                </div>
            </div>
    ...
    <li class="pull-right"><a href="#" class="text-mute"><span id="post_like_count_{{$post['id']}}">{{$post['likes']}}</span> Likes</a></li>
            ...
            <div class="post-comment" id="post_comment_{{$post['id']}}" style="display:none;">
                ...
                @endforeach
                <div class="row">
                    <form action="{{route('saveCommment')}}" method="POST">
                        @csrf
                        <div class="col-sm-1 form-group">
                            <a href="profile.html">
                                <img src="{{asset(auth()->user()->image ?? '/image/no_user.png')}}" class="profile-picture-small pull-left"/>
                            </a>
                        </div>
